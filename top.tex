...
\section{Functional Limits and Continuity}
	...
	\begin{rmklist}
		...
		\item the point at which the limit is being evaluated lies in the domain, in which case, the specification of ambient space is redundant (see \ref{LEMiii: lims at isolated and lim pts} of \myRef{LEM: lims at isolated and lim pts}).
	\end{rmklist}
