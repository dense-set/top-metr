...
\section{Limits and Continuity}
	...
	\begin{proof}
		...
		\begin{mylist}
			...
			\item Since if $c\in E$, then for any $X_1, X_2\supseteq E$, if $U_1$ is an \onbd of $c$ in $X_i$, then $E\cap U_1$, being an \onbd of $c$ in $E$, is equal to $E\cap U_2$ for some \onbd $U_2$ of $c$ in $X_2$.
		\end{mylist}
	\end{proof}
